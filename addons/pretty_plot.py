...
ls_markers = cycle([("-", "o"), ("-", "p"), ("-", "D"), ("-", "^"), ("-", "s"),
               ("-", "8"), ("-", "o"), ("-", "o"), ("-", "o"), ("-", "o"), 
               ("-", "o"), ("-", "o")])
colors = cycle(['#741111', "#000000", '#3a49ba','#7634c9', 
...
class PrettyPlot:
    ...
    def add_yxList(self, y_vals, x_vals, label,color=None,
    ls_marker=None, converged = None):
        ...
        if color is None:
            self.color_list += [next(colors)]
        else:
            self.color_list += [color]

        if ls_marker is None:
            self.ls_marker_list += [next(ls_markers)]
        else:
            self.ls_marker_list += [ls_marker]
    ...
    def plot(self, y_list=None, x_list=None, labels=None, ax=None, 
        ...
        if y_list == None and x_list == None:
            ...
            ls_marker_list = self.ls_marker_list
